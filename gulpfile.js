...
var swigOpts = {
    defaults: {
        cache: false,
        loader: swigEngine.loaders.fs(__dirname + '/app/views' )
    }
};
...
gulp.task('serve', ['templating', 'styles', 'fonts'], function () {
  browserSync({
    notify: false,
    port: 9000,
    server: {
  ...
  gulp.watch('app/**/*.html', ['templating']);
